...
def create_image_lists(summaries_dir, image_dir, testing_percentage, validation_percentage):
...
def main(_):
  ...
  image_lists = create_image_lists(FLAGS.summaries_dir, FLAGS.image_dir, FLAGS.testing_percentage,
